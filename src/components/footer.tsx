  ...
  return (
    <footer className="mt-20 mb-10">
      <div className="max-w-3xl mx-auto px-6">
        <div className="border-t border-neutral-200/60 dark:border-neutral-700/40 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-5 text-sm text-neutral-500 dark:text-neutral-400">
              ...
              <a
                ...
                className="hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors inline-flex items-center gap-1.5"
                aria-label="GitHub"
              >
                <svg
                  className="w-4 h-4"
            ...
            <p className="text-sm text-neutral-400 dark:text-neutral-500">
              © {new Date().getFullYear()} 0xharryriddle
            </p>
          </div>
        </div>
      </div>
