...
export function ProjectCard({
  ...
  return (
    <a href={url} target="_blank" rel="noopener noreferrer">
      <div
        className="
          h-full p-5 rounded-xl border border-[var(--border)]
          bg-[var(--card-bg)] shadow-sm
          transition-all duration-300
          hover:shadow-md hover:border-[var(--text-muted)]/30 hover:-translate-y-0.5
          flex flex-col
        "
      >
        {/* Header */}
    ...
    <div className="p-5 rounded-xl border border-[var(--border)] bg-[var(--card-bg)] shadow-sm">
      <div className="space-y-3 animate-pulse">
        ...
        <div className="flex gap-4">
          ...
          <div className="h-3 w-8 bg-[var(--border)] rounded" />
          <div className="h-3 w-20 bg-[var(--border)] rounded ml-auto" />
        </div>
      </div>
    </div>
  )
