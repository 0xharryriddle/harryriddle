...
function ComingSoonSection({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-10 px-6 rounded-xl border border-dashed border-[var(--border)] text-center">
      ...
      <h3 className="font-medium text-[var(--text-primary)] mb-1.5">{title}</h3>
    ...
    <section className="py-8 space-y-10">
      ...
      <div>
        ...
        <p className="text-[var(--text-secondary)] leading-relaxed max-w-2xl">
          Tutorials and guides for building on Polkadot, Substrate, and the broader Web3 ecosystem.
          I believe the best way to learn is by building — so these are hands-on, step-by-step, and
          designed to get you from zero to something real. I also speak at events and mentor
